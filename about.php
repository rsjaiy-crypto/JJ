    ...
    <div class="container">
      ...
      <div class="ab-qa__list">
        ...
        <div class="ab-qa__item">
          ...
          <div class="ab-qa__body">
            <p class="ab-qa__answer"><?php esc_html_e( 'This is the itinerary I would build for anyone who wants to see Peru properly, not just tick off Machu Picchu. Start in Lima and give it a few real days: a food walking tour, fresh fruit from the markets, chocolate cake at Vekia, which is still the most decadent thing I have ever eaten, ceviche or causa for lunch, dinner at Panchita, and an afternoon at the Choco Museo. From there, fly to Iquitos for a weekend in the Amazon: the monkey jungle, the animal sanctuary, and hugging the sloths, which I have genuinely done. Back to Lima for a day to reset, then on to Cusco for a few days to acclimatise before taking the train to Aguas Calientes via Ollantaytambo. From Aguas Calientes, the bus climbs up to Machu Picchu itself. On the way back, stop in Ollantaytambo to see the ruins properly and spend a night at a hotel overlooking the glaciers. The next day is the Sacred Valley: the salt flats, horse riding or quad biking through the valley, a long lunch, and more llama photos than anyone needs. All of this is from my own trip, not a guess. Fly back to Lima one final time, then close with a weekend in Huacachina and Paracas: a picnic and a private oasis in the desert, before the sand dunes of Huacachina itself.', 'jaiye-journeys' ); ?></p>
          </div>
        </div>
