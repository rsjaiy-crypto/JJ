    ...
    <div class="container">
      ...
      <div class="ab-qa__list">
        ...
        <div class="ab-qa__item">
          ...
          <div class="ab-qa__body">
            <p class="ab-qa__answer"><?php esc_html_e( 'This is a dream itinerary because it is one I have actually done, over about a month. Keep each Lima stop to three or four days between legs and the whole thing works in two weeks. Start in Lima and give it real time: a food walking tour, fresh fruit from the markets, chocolate cake at Vekia (still the most decadent thing I have ever eaten), ceviche or causa for lunch, dinner at Panchita or Central, and an afternoon at the Choco Museo. Lima is often called the culinary capital of South America, and with restaurants like Central and Maido regularly ranked among the World\'s 50 Best, it earns the title. From there, fly to Iquitos for a weekend in the Amazon: the monkey jungle, the animal sanctuary, and hugging the sloths, which I have genuinely done. Lima is the hub for internal flights in Peru, so you land back there for a few more days of eating before heading on to Cusco to acclimatise ahead of the altitude. From Cusco, take the train to Aguas Calientes via Ollantaytambo, then the bus up to Machu Picchu itself. On the way back, stop in Ollantaytambo to see the ruins properly and spend a night at a hotel overlooking the glaciers. The next day is the Sacred Valley: the salt flats, horse riding or quad biking, a long lunch, and more llama photos than anyone needs. All of this is from my own trip, not a guess. Fly back to Lima once more, then close with a weekend in Huacachina and Paracas: a picnic and a private oasis in the desert, before the sand dunes of Huacachina itself.', 'jaiye-journeys' ); ?></p>
          </div>
        </div>
