    ...
    <div class="container">
      ...
      <div class="ab-qa__list">
        ...
        <div class="ab-qa__item">
          ...
          <div class="ab-qa__body">
            <p class="ab-qa__answer"><?php esc_html_e( 'This one\'s real. I\'ve done it myself, and it works comfortably in two weeks.', 'jaiye-journeys' ); ?> <strong><?php esc_html_e( 'WE\'RE GOING TO PERU, BABY!', 'jaiye-journeys' ); ?></strong> <?php esc_html_e( 'Start with three days in Lima. A food walking tour, fresh fruit from the markets, chocolate cake at Vekia (still the most decadent thing I\'ve ever eaten), ceviche or causa for lunch, dinner at Panchita (or Central, if you want to know you\'re eating at a former World\'s Best). Spend a morning at Museo Larco for pre-Columbian art and an afternoon at the Choco Museo. Maido, also in Lima, was named the World\'s Best Restaurant in 2025. You\'re not just eating well here, you\'re eating at one of the best tables on earth.', 'jaiye-journeys' ); ?></p>
            <p class="ab-qa__answer"><?php esc_html_e( 'Fly to Cusco and give yourself two days to acclimatise before the altitude catches you off guard. This isn\'t a hiking trip: take the train, PeruRail or the Belmond Hiram Bingham if you want to do it properly, through Ollantaytambo to Aguas Calientes, then the bus up to Machu Picchu. On the way back, stop in Ollantaytambo properly and spend a night at a hotel looking out at the glaciers. The next day is the Sacred Valley: salt flats, horse riding or quad biking, a long lunch, and more llama photos than anyone strictly needs.', 'jaiye-journeys' ); ?></p>
            <p class="ab-qa__answer"><?php esc_html_e( 'Fly back to Lima, then it\'s a three-and-a-half-hour drive down the coast to Huacachina and Paracas. Close with a weekend there: a picnic in a private desert oasis, then the dunes themselves, before flying home from Lima.', 'jaiye-journeys' ); ?></p>
            <p class="ab-qa__answer"><?php esc_html_e( 'Fourteen days, done properly, no rushing.', 'jaiye-journeys' ); ?></p>
            <p class="ab-qa__answer"><?php esc_html_e( 'Want the Amazon in there too? Add two days. Fly to Iquitos after your first 3 days in Lima instead of straight to Cusco, spend three days in the rainforest (the monkey jungle, the animal sanctuary\'s rescued and endangered wildlife, and time with the communities who really live there), then connect back through Lima on to Cusco. Sixteen days total, and worth every one of them.', 'jaiye-journeys' ); ?></p>
          </div>
        </div>
